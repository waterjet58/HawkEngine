...
namespace Hawk {
    ...
    DescriptorPool::DescriptorPool(
        ...
        if (vkCreateDescriptorPool(context.getDevice(), &descriptorPoolInfo, nullptr, &descriptorPool) !=
            VK_SUCCESS) {
    ...
    bool DescriptorPool::allocateDescriptor(
        ...
        if (vkAllocateDescriptorSets(context.getDevice(), &allocInfo, &descriptor) != VK_SUCCESS) {
            return false;
        }
        return true;
    }
    ...
    void DescriptorPool::resetPool() {
        vkResetDescriptorPool(context.getDevice(), descriptorPool, 0);
    }
    ...
    void DescriptorWriter::overwrite(VkDescriptorSet& set) {
        ...
        vkUpdateDescriptorSets(pool.context.getDevice(), writes.size(), writes.data(), 0, nullptr);
    }
