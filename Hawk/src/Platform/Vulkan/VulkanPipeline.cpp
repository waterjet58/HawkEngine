...
namespace Hawk {
	...
	PipelineConfigInfo VulkanPipeline::defaultPipelineConfigInfo(uint32_t width, uint32_t height)
	{
		...
		//Viewport changes the aspect ratio of the rendered viewport by squishing
		...
		//Scissor cuts off the rendering showing only what is inside the offset and extent
